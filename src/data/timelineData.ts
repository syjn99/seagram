...
export const timelineData: TimelineData = {
  ...
  phases: [
    ...
    },
    {
      ...
      paragraphs: [
        "The bronze cladding was intended to develop a warm, golden-brown patina over time — a living surface that would age with dignity. To ensure this, the building's maintenance program specified that each of the bronze mullions and spandrels be hand-rubbed annually with lemon oil, a process designed to produce a warm, even oxidation.",
